...
add1 macro filenam , counter1  ;Add New Item to File
...
.while cx!=counter1     ;Moves to end of filee
inc si
inc cx
.endw
print newdish      	    ;Ask for input
push cx
mov cx,13				;New line at end of file
mov [si],cx
inc si
mov cx,10
mov [si],cx
...
write_file filenam,counter1  ;Write Buffer to File
...
write_file macro m69 , counterr		;Write buffer to file
